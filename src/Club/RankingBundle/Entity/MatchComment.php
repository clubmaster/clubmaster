...
/**
 * Club\RankingBundle\Entity\MatchComment
 *
 * @ORM\Table(name="club_ranking_match_comment")
 * @ORM\Entity(repositoryClass="Club\RankingBundle\Entity\MatchCommentRepository")
