...
/**
 * Club\RankingBundle\Entity\Team
 *
 * @ORM\Table(name="club_ranking_team")
 * @ORM\Entity(repositoryClass="Club\RankingBundle\Entity\TeamRepository")
 */
class Team
{
    /**
     ...
     * @ORM\JoinTable(name="club_ranking_team_user")
     */
    protected $users;
