...
INSERT INTO `club_account_account` VALUES (1,'Cash In Bash','1010','asset'),(2,'VAT','3001','income'),(3,'Income','5001','income'),(4,'Discount','5020','income');
...
--
-- Table structure for table `club_shop_coupon`
--

DROP TABLE IF EXISTS `club_shop_coupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `club_shop_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_3FEF410B6B47CF43` (`coupon_key`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `club_shop_coupon`
--

LOCK TABLES `club_shop_coupon` WRITE;
/*!40000 ALTER TABLE `club_shop_coupon` DISABLE KEYS */;
/*!40000 ALTER TABLE `club_shop_coupon` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `club_shop_coupon_log`
--

DROP TABLE IF EXISTS `club_shop_coupon_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `club_shop_coupon_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `coupon_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_B8DD3D766C5951B` (`coupon_id`),
  KEY `IDX_B8DD3D7A76ED395` (`user_id`),
  CONSTRAINT `club_shop_coupon_log_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `club_user_user` (`id`),
  CONSTRAINT `club_shop_coupon_log_ibfk_1` FOREIGN KEY (`coupon_id`) REFERENCES `club_shop_coupon` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `club_shop_coupon_log`
--

LOCK TABLES `club_shop_coupon_log` WRITE;
/*!40000 ALTER TABLE `club_shop_coupon_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `club_shop_coupon_log` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `club_shop_subscription` (
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_69CFA546F65E9B0F` (`order_product_id`),
  KEY `IDX_69CFA5468D9F6D38` (`order_id`),
  KEY `IDX_69CFA546A76ED395` (`user_id`),
  CONSTRAINT `club_shop_subscription_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `club_user_user` (`id`),
  CONSTRAINT `club_shop_subscription_ibfk_1` FOREIGN KEY (`order_product_id`) REFERENCES `club_shop_order_product` (`id`),
  CONSTRAINT `club_shop_subscription_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `club_shop_order` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `club_task_task` VALUES (1,'Update dynamic groups',1,0,'\\Club\\TaskBundle\\Event\\Events','onGroupTask','2011-07-21 14:31:52','2011-07-21 14:31:52',NULL,'2011-07-21 14:31:52','+1 hour'),(2,'Cleanup logs',1,0,'\\Club\\TaskBundle\\Event\\Events','onLogTask','2011-07-21 14:31:52','2011-07-21 14:31:52',NULL,'2011-07-21 14:31:52','+1 hour'),(3,'Renewal memberships',1,0,'\\Club\\TaskBundle\\Event\\Events','onAutoRenewalTask','2011-07-21 14:31:52','2011-07-21 14:31:52',NULL,'2011-07-21 14:31:52','+1 hour'),(4,'Cleanup login logs',1,0,'\\Club\\TaskBundle\\Event\\Events','onLoginAttemptTask','2011-07-21 14:31:52','2011-07-21 14:31:52',NULL,'2011-07-21 14:31:52','+1 hour'),(5,'Cleanup ban logs',1,0,'\\Club\\TaskBundle\\Event\\Events','onBanTask','2011-07-21 14:31:52','2011-07-21 14:31:52',NULL,'2011-07-21 14:31:52','+1 hour'),(6,'Send emails',1,0,'\\Club\\TaskBundle\\Event\\Events','onMailTask','2011-07-21 14:31:52','2011-07-21 14:31:52',NULL,'2011-07-21 14:31:52','+1 hour');
...
INSERT INTO `club_user_attribute` VALUES (1,'name'),(2,'member_number'),(3,'min_age'),(4,'max_age'),(5,'gender'),(6,'postal_code'),(7,'city'),(8,'country'),(9,'active'),(10,'has_ticket'),(11,'has_subscription'),(12,'location');
...
INSERT INTO `club_user_config` VALUES (1,'account_default_cash'),(4,'account_default_discount'),(2,'account_default_income'),(3,'account_default_vat'),(6,'default_currency'),(5,'default_language'),(7,'default_location'),(8,'email_sender_address'),(9,'email_sender_name');
...
INSERT INTO `club_user_currency` VALUES (1,'US Dollar','USD','$',NULL,'2','1.00000',0,'2011-07-21 14:31:52','2011-07-21 14:31:52'),(2,'Euro','EUR','€',NULL,'2','1.00000',0,'2011-07-21 14:31:52','2011-07-21 14:31:52'),(3,'Danish Krone','DKK',NULL,'DK','2','1.00000',0,'2011-07-21 14:31:52','2011-07-21 14:31:52');
...
CREATE TABLE `club_user_group` (
  ...
  `active_member` tinyint(1) DEFAULT NULL,
  `updated_at` datetime NOT NULL,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `club_user_group` VALUES (1,NULL,'Super Administrators','static',NULL,NULL,NULL,NULL,'2011-07-21 14:31:52','2011-07-21 14:31:52'),(2,NULL,'Event Managers','static',NULL,NULL,NULL,NULL,'2011-07-21 14:31:52','2011-07-21 14:31:52');
...
INSERT INTO `club_user_group_role` VALUES (1,1),(2,3);
...
INSERT INTO `club_user_location_config` VALUES (1,1,'1','account_default_cash'),(2,1,'3','account_default_income'),(3,1,'2','account_default_vat'),(4,1,'4','account_default_discount'),(5,1,'1','default_language'),(6,1,'1','default_currency'),(7,1,'2','default_location'),(8,1,'noreply@clubmaster.dk','email_sender_address'),(9,1,'ClubMaster','email_sender_name');
...
CREATE TABLE `club_user_profile` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `profile_address_id` int(11) DEFAULT NULL,
  `profile_phone_id` int(11) DEFAULT NULL,
  `profile_email_id` int(11) DEFAULT NULL,
  `profile_company_id` int(11) DEFAULT NULL,
  `first_name` varchar(255) NOT NULL,
  `last_name` varchar(255) NOT NULL,
  ...
  KEY `IDX_A3EE1CF532DC9828` (`profile_address_id`),
...
INSERT INTO `club_user_role` VALUES (1,'ROLE_SUPER_ADMIN'),(2,'ROLE_ADMIN'),(3,'ROLE_EVENT_ADMIN');
...
-- Dump completed on 2011-07-21 14:31:52
