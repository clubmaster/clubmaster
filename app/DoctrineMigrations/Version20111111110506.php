 ...
 */
class Version20111111110506 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE club_team_schedule (id INT AUTO_INCREMENT NOT NULL, team_id INT DEFAULT NULL, schedule_id INT DEFAULT NULL, level_id INT DEFAULT NULL, repetition_id INT DEFAULT NULL, description LONGTEXT NOT NULL, max_attend INT NOT NULL, first_date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_5FBD8B31296CD8AE (team_id), INDEX IDX_5FBD8B31A40BC2D5 (schedule_id), INDEX IDX_5FBD8B315FB14BA7 (level_id), UNIQUE INDEX UNIQ_5FBD8B31A06DF6FF (repetition_id), PRIMARY KEY(id)) ENGINE = InnoDB");
        ...
        $this->addSql("ALTER TABLE club_shop_subscription_ticket CHANGE created_at created_at DATETIME NOT NULL");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE club_shop_subscription_ticket CHANGE created_at created_at DATE NOT NULL");
    }
}
