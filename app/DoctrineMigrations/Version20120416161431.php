 ...
 */
class Version20120416161431 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE club_match_match_league_table (id INT AUTO_INCREMENT NOT NULL, league_id INT DEFAULT NULL, team_id INT DEFAULT NULL, played INT NOT NULL, win INT NOT NULL, loss INT NOT NULL, point INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_E3F85A3E58AFC4DE (league_id), INDEX IDX_E3F85A3E296CD8AE (team_id), PRIMARY KEY(id)) ENGINE = InnoDB");
