...
if (!version_compare(phpversion(), '5.3.2', '>=')) {
    $version = phpversion();
    $majorProblems[] = <<<EOF
        You are running PHP version "<strong>$version</strong>", but ClubMaster
        needs at least PHP "<strong>5.3.2</strong>" to run. Before using ClubMaster, install
        ...
        <div id="symfony-wrapper">
            <div id="symfony-content">
                ...
                <div class="symfony-block-logo">
                    <img src="bundles/symfonywebconfigurator/images/logo-big.gif" alt="ClubMaster" />
                </div>
                ...
                <div class="symfony-block-content">
                    ...
                    <?php if (count($minorProblems)): ?>
                        ...
                        <p>
                            ...
                            <?php else: ?>
                                To<?php endif; ?>
                            enhance your ClubMaster experience, it’s recommended that you fix the following :
                        </p>
                        <ol>
                    ...
                    <ul class="symfony-install-continue">
                        <?php if (!count($majorProblems)): ?>
                            <li><a href="app_dev.php/installer">Configure your ClubMaster Application online</a></li>
                        <?php endif ?>
